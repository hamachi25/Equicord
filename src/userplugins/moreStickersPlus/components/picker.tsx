    ...
    return (
        <div
            ...
            onClick={e => {
                ...
                sendSticker({ channelId, sticker, ctrlKey: e.ctrlKey, shiftKey: e.shiftKey, ffmpegState, overlayText });
                        ...
                        <IconContainer>
                            {
                                (query && query.length > 0) ?
                                    <CancelIcon className={clPicker("clear-icon")} width={20} height={20} color="var(--text-muted)" onClick={() => setQueryDebounced("", true)} /> :
